...
export type CurrentUserQuery = { __typename?: 'Query', currentUser: { __typename?: 'CurrentUserModel', id: string, name: string, imageUrl: string } };
...
export type FollowersQuery = { __typename?: 'Query', follower: { __typename?: 'PaginatedFollowerModel', pageInfo: { __typename?: 'FollowerModelPageInfo', hasNextPage: boolean, endCursor?: string | null }, edges: Array<{ __typename?: 'FollowerModelEdge', node: { __typename?: 'FollowerModel', followedUser: { __typename?: 'UserModelBase', id: string, name: string, imageUrl: string } } }> } };
...
export type FollowingQuery = { __typename?: 'Query', following: { __typename?: 'PaginatedFollowingModel', edges: Array<{ __typename?: 'FollowingModelEdge', node: { __typename?: 'FollowingModel', followingUser: { __typename?: 'UserModelBase', id: string, name: string, imageUrl: string } } }>, pageInfo: { __typename?: 'FollowingModelPageInfo', hasNextPage: boolean, endCursor?: string | null } } };
...
export type PostQuery = { __typename?: 'Query', post: { __typename?: 'PostModel', id: string, caption?: string | null, createdAt: any, imageUrl: string, user: { __typename?: 'UserModelBase', id: string, name: string, imageUrl: string } } };
...
export type UploadMutation = { __typename?: 'Mutation', upload: { __typename?: 'PostModel', id: string, caption?: string | null, createdAt: any, imageUrl: string } };

export type PostsIdAndUsersIdQueryVariables = Exact<{ [key: string]: never; }>;


export type PostsIdAndUsersIdQuery = { __typename?: 'Query', posts: { __typename?: 'PaginatedPostsModel', nodes: Array<{ __typename?: 'PostModel', id: string, userId: string }> } };

export type PostsIdAndUsersIdUpdatedAtQueryVariables = Exact<{ [key: string]: never; }>;


export type PostsIdAndUsersIdUpdatedAtQuery = { __typename?: 'Query', posts: { __typename?: 'PaginatedPostsModel', nodes: Array<{ __typename?: 'PostModel', id: string, userId: string, updatedAt: any }> } };
...
export type PostsQuery = { __typename?: 'Query', posts: { __typename?: 'PaginatedPostsModel', pageInfo: { __typename?: 'PostModelPageInfo', hasNextPage: boolean, endCursor?: string | null }, edges: Array<{ __typename?: 'PostModelEdge', node: { __typename?: 'PostModel', id: string, caption?: string | null, imageUrl: string, createdAt: any, user: { __typename?: 'UserModelBase', id: string, name: string, imageUrl: string } } }> } };
...
export type UserQuery = { __typename?: 'Query', user: { __typename?: 'UserModelBase', id: string, name: string, imageUrl: string, posts: { __typename?: 'PaginatedPostModel', totalCount: number }, follower: { __typename?: 'PaginatedFollowerModel', totalCount: number }, following: { __typename?: 'PaginatedFollowingModel', totalCount: number } } };
...
export type UserPostsQuery = { __typename?: 'Query', user: { __typename?: 'UserModelBase', posts: { __typename?: 'PaginatedPostModel', edges: Array<{ __typename?: 'PostModelBaseEdge', node: { __typename?: 'PostModelBase', id: string, imageUrl: string } }>, pageInfo: { __typename?: 'PostModelBasePageInfo', endCursor?: string | null, hasNextPage: boolean } } } };

export type UsersIdQueryVariables = Exact<{ [key: string]: never; }>;


export type UsersIdQuery = { __typename?: 'Query', users: { __typename?: 'PaginatedUserModel', nodes: Array<{ __typename?: 'UserModelBase', id: string }> } };
...
export type UsersQuery = { __typename?: 'Query', users: { __typename?: 'PaginatedUserModel', pageInfo: { __typename?: 'UserModelBasePageInfo', hasNextPage: boolean, endCursor?: string | null }, edges: Array<{ __typename?: 'UserModelBaseEdge', node: { __typename?: 'UserModelBase', id: string, name: string, imageUrl: string } }> } };
...
export type UsersFilterQuery = { __typename?: 'Query', users: { __typename?: 'PaginatedUserModel', nodes: Array<{ __typename?: 'UserModelBase', id: string, name: string, imageUrl: string }> } };
